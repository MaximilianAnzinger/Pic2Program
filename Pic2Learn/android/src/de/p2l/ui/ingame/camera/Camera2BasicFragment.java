...
public class Camera2BasicFragment extends Fragment
    ...
    private Result current_state = null;
  ...
  public void onViewCreated(final View view, Bundle savedInstanceState) {
    ...
    textView = (TextView) view.findViewById(R.id.text);
      ...
      selectedListPosition = SharedPrefManager.readInt(getActivity(), getString(R.string.selected_position_key));
  }
  ...
  public void onPause() {
      ...
      SharedPrefManager.write(getActivity(), selectedListPosition, getString(R.string.selected_position_key));
    closeCamera();
  ...
  private void onClickFloatingActionButton() {
    Log.e("floatButton", current_state.toString());
        final Input input = (Input) current_state;
  ...
  private void classifyFrame() {
    ...
    Bitmap bitmap =
        textureView.getBitmap(classifier.DIM_IMG_SIZE_X(), classifier.DIM_IMG_SIZE_Y());
    current_state = classifier.classify(bitmap);
    String textToShow = classifier.printTopKLabels();
    bitmap.recycle();
